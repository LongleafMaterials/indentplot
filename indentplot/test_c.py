...
RESULT_FILE = 'N:\\Samples\\Nanoindentation\\Nanoindentation Data\\Processed Data\\E-beam_W.txt'
RESULT_FOLDER = 'N:\\Samples\\Nanoindentation\\Nanoindentation Data\\Raw Data\\'

# Parse/process Bruker data files
parsed_data = parse.brukerTDM(RESULT_FOLDER)
test_data = indentplot.TestData(parsed_data, RESULT_FILE)
...
coord = coordinates.label_indents(image_path)
...
pixel_coord = coordinates.transform_grid(coord, 
                                         test_data.results)
